     ...
     <table class="tbl-30">
        ...
        <?php
             ...
             if(isset($_POST['submit']))
             {
                ...
                if  ($res2==true)
                {
                    $_SESSION['update'] = "<div class='success'>Category has been updated successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                } 
                else
                {
                    $_SESSION['update'] = "<div class='error'>Category has been updated successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                }
